...
import { FileText, Trash2, Database, Layers } from 'lucide-react';
                ...
                >
                  ...
                  <td className="py-3.5 px-4 text-right">
                    <button
                      ...
                      disabled={isDeleting}
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded text-[11px] font-mono text-rose-400 hover:text-white hover:bg-rose-900/60 border border-rose-800/40 transition-colors disabled:opacity-50"
