 ...
 * --------------------------------------------
 * Single-Window Engineering Console (White & Light Blue Theme)
 * Displays all 12 Core Workbench Modules with clear categorization.
 */
      ...
      <header className="border-b-2 border-[#cbd5e1] bg-white px-4 py-2 flex flex-col xl:flex-row xl:items-center justify-between gap-2 shrink-0 select-none brutal-shadow-sky z-20 font-mono">
        ...
        <div className="flex items-center justify-between gap-3 shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-[#0284c7] border-2 border-black flex items-center justify-center text-white font-black font-display text-sm">
              S
            </div>
            <div>
        ...
        {/* Navigation Tabs Strip (All 12 Modules Visible) */}
